...
$user = $_SESSION['username']; // Menggunakan nama pengguna yang login
...
<div class="container chat-container">
    ...
    <div class="chat-box" id="chatBox">
        <?php while ($row = $result->fetch_assoc()) { ?>
            <div class="message <?= ($row['pengirim'] == $user) ? 'user' : 'other' ?>">
    ...
    <!-- Input Chat -->
    <form action="send_chatuser.php" method="POST" class="mt-3">
        <div class="input-group">
            <input type="text" name="pesan" class="form-control" placeholder="Ketik pesan..." required>
            <input type="hidden" name="pengirim" value="<?= htmlspecialchars($user) ?>">
