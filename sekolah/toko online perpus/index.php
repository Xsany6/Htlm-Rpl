...
<head>
    ...
    .custom-dropdown {
        ...
        /* Efek blur agar tetap terlihat jelas */
    ...
    .user-info img {
        width: 40px;
        /* Atur ukuran foto agar lebih kecil */
        height: 40px;
        /* Pastikan proporsi tetap */
        border-radius: 50%;
        /* Membuat gambar bundar */
        object-fit: cover;
        /* Mencegah distorsi dan memastikan gambar terpotong dengan baik */
        border: 2px solid white;
        /* Opsional: Tambahkan border agar lebih jelas */
    }
    ...
    .modal-content {
        ...
        z-index: 10000;
        /* Pastikan konten modal tidak tertutup */
    }
...
<body>
                ...
                <button type="submit">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                        <path fill="currentColor"
                            d="M15.5 14h-.79l-.28-.27a6.518 6.518 0 0 0 1.48-5.34C15.13 5.02 12.11 2 8.5 2S1.87 5.02 1.87 8.5 5.02 15 8.5 15c1.61 0 3.09-.59 4.24-1.57l.27.28v.79l4.25 4.25c.41.41 1.08.41 1.5 0s.41-1.08 0-1.5l-4.26-4.25zM3.87 8.5C3.87 6.02 5.97 4 8.5 4s4.63 2.02 4.63 4.5S11.03 13 8.5 13s-4.63-2.02-4.63-4.5z" />
                    </svg>
                </button>
            </form>
            ...
            <ul class="cart-list">
                ...
                <li class="cart-item">
                    <img src="<?= htmlspecialchars($productImage) ?>"
                        alt="<?= htmlspecialchars($item['name'] ?? 'Nama Tidak Tersedia') ?>" class="item-image"
    ...
    <main class="product-container">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                ...
                <a href="cart.php?action=add&id=<?= $row['id'] ?>&name=<?= urlencode($row['name']) ?>&price=<?= $row['price'] ?>&stok=<?= $row['stok'] ?>"
    ...
    <div class="payment-slider">
        <div class="payment-track">
            ...
            <img src="./images/png-transparent-bank-mandiri-bank-syariah-mandiri-logo-bank-text-logo-loan-thumbnail.png"
                alt="Mandiri">
