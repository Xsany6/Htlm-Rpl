...
<div class="container">
    ...
    <form id="profileForm" method="POST" enctype="multipart/form-data">
        <div class="mb-3 text-center">
            <img src="<?= !empty($user['profile_pic']) ? htmlspecialchars($user['profile_pic']) : 'https://via.placeholder.com/120' ?>" alt="Foto Profil" id="previewImage" class="profile-pic">
        </div>
        <div class="mb-3">
...
<div id="message" class="alert text-center" style="display: none;"></div>
        ...
        <div class="mb-3">
            ...
            <div>
                ...
                <input type="radio" name="gender" value="Lainnya" <?= $user['gender'] == 'Lainnya' ? 'checked' : '' ?>> Lainnya
            </div>
        </div>
        <div class="mb-3">
